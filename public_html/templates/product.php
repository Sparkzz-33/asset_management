      ...
      <div class="modal-body">
        <form id = "product_form" onsubmit="return false">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="product_price" name="product_price" placeholder="Enter Price of the Product">
          </div>

          <div class="form-group">
            <label>Quantity</label>
            <input type="text" class="form-control" id="product_qty" name="product_qty" placeholder="Enter quantity of the Product">
          </div>
